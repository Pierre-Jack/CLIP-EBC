...
class CrowdDali(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # ---------------------------------------------------------
        # THE DOCUMENTED PATTERN: The proxy is called as the transform!
        # It returns proxy placeholder objects that the DALI DataLoader natively understands.
        # ---------------------------------------------------------
        if self.transform is not None:
            return self.transform(images=encoded_image, labels=label)
